    ...
    <>
      ...
      <div className='absolute inset-0 overflow-hidden'>
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, rgba(16, 185, 129, 0.3) 0%, rgba(20, 184, 166, 0.25) 50%, transparent 70%)',
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, rgba(236, 72, 153, 0.35) 0%, rgba(139, 92, 246, 0.3) 50%, transparent 70%)',
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, rgba(34, 211, 238, 0.3) 0%, rgba(20, 184, 166, 0.25) 50%, transparent 70%)',
