        ...
        <div className='flex items-center justify-between'>
          <div className='flex items-center gap-3'>
            ...
            <div className='relative'>
              <Avatar className='w-10 h-10 rounded-xl shadow-lg shadow-purple-500/20'>
                <AvatarFallback className='bg-gradient-to-br from-purple-500 via-pink-500 to-cyan-500 rounded-xl'>
          ...
          <div className='flex items-center gap-2'>
            <Badge 
              variant="outline" 
              className={cn(
                'backdrop-blur-md bg-gradient-to-r from-purple-500/10 to-cyan-500/10',
            ...
            <Badge 
              variant="outline"
              className={cn(
                'backdrop-blur-md bg-gradient-to-r from-cyan-500/10 to-teal-500/10',
                'border-white/10 text-white text-xs px-2.5 py-1',
            ...
            <Badge 
              variant="outline"
              className={cn(
                'backdrop-blur-md bg-gradient-to-r from-pink-500/10 to-orange-500/10',
                'border-white/10 text-white text-xs px-2.5 py-1',
