...
import { ApiResultBlock } from '@/app/components/ApiResultBlock'
import { MarkdownRenderer } from '@/app/components/MarkdownRenderer'
import { MessageActions } from '@/app/components/MessageActions'
import { ToolCallBlock } from '@/app/components/ToolCallBlock'
import { extractTextContent, extractImageUrls, extractMediaUrls, extractDocumentUrls } from '@/app/utils/message'
...
export function MessageBubble({ message }: MessageBubbleProps) {
  ...
  const hasContent = textContent || imageUrls.length > 0 || mediaUrls.length > 0 || documentUrls.length > 0
