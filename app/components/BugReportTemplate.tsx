...
export function BugReportTemplate({
  ...
  // TODO: 更新字段
  const updateField = <K extends keyof BugReport>(field: K, value: BugReport[K]) => {
  ...
  // TODO: 格式化为 Jira 格式
  const formatForJira = (report: BugReport): string => {
  ...
  // TODO: 格式化为禅道格式
  const formatForZentao = (report: BugReport): string => {
    // TODO: 生成禅道格式
    return ''
  }

  // TODO: 格式化为 GitLab/GitHub Issue 格式
  const formatForGitHub = (report: BugReport): string => {
...
// TODO: 严重程度选项
export const severityOptions: { value: BugSeverity; label: string; color: string }[] = [
...
// TODO: 优先级选项
export const priorityOptions: { value: BugPriority; label: string }[] = [
