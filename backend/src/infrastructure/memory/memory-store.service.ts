...
export class MemoryStoreService {
  ...
  async getMergedMemoryForSession(
    sessionId: string,
    userId?: string,
    ...
    const folderMemories = session?.folderId
      ? await this.getFolderMemories(session.folderId)
      : [];
